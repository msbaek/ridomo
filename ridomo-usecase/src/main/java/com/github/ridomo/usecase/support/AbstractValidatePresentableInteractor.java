...
public abstract class AbstractValidatePresentableInteractor<T extends RequestModel, S extends ResponseModel> extends AbstractValidateInteractor<T> implements PresentableInteractor<T, S> {
